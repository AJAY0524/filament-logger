...
namespace AJAY0524\FilamentLogger\Resources\ActivityResource\Tables;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('created_at')
                    ...
                    ->dateTime(config('filament-logger.datetime_format', 'Y/m/d H:i:s'), config('app.timezone'))
                    ->sortable(),
            ])
                ...
                Filter::make('created_at')
                    ->form([
                        DatePicker::make('logged_at')
                            ->label(__('filament-logger::filament-logger.resource.label.logged_at'))
                            ->displayFormat(config('filament-logger.date_format', 'Y/m/d')),
                    ])
                    ->query(function (Builder $query, array $data): Builder {
                        return $query
                            ->when(
